...
var moduleMap = {
	"./footer": () => {
		return __webpack_require__.e(646).then(() => (() => ((__webpack_require__(5646)))));
	}
};
...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					register("react-dom", "18.0.0-beta-149b420f6-20211119", () => (__webpack_require__.e(378).then(() => (() => (__webpack_require__(7262))))));
