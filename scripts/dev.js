...
const [clientConfig, remoteConfig, serverConfig] = configFactory('development')

// Create the development build and print the deployment instructions.
const build = async previousFileSizes => {
  console.log(`Running a ${chalk.green('DEVELOPMENT')} build of the application`)
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(
    ({stats, previousFileSizes, warnings}) => {
      ...
      console.log(`Files for ${chalk.green('DEVELOPMENT')} instance output to /${chalk.green(buildFolder)}`)
